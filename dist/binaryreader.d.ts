...
export declare function getCharCodes(str: string): Uint8Array<ArrayBuffer>;
...
export declare class BinaryReader {
    ...
    getDataView(): DataView<ArrayBufferLike>;
    tell(): number;
    ...
    getBytes(byteLength: number, byteOffset?: number): Uint8Array<ArrayBufferLike>;
    ...
    getVector2(byteOffset?: number, littleEndian?: boolean, vec?: Float32Array<ArrayBuffer>): Float32Array<ArrayBuffer>;
    getVector3(byteOffset?: number, littleEndian?: boolean, vec?: Float32Array<ArrayBuffer>): Float32Array<ArrayBuffer>;
    getVector4(byteOffset?: number, littleEndian?: boolean, vec?: Float32Array<ArrayBuffer>): Float32Array<ArrayBuffer>;
    getVector48(byteOffset?: number, littleEndian?: boolean, vec?: Float32Array<ArrayBuffer>): Float32Array<ArrayBuffer>;
    getQuaternion(byteOffset?: number, littleEndian?: boolean, vec?: Float32Array<ArrayBuffer>): Float32Array<ArrayBuffer>;
